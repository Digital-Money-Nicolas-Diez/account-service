...
public class AccountsController {
    ...
    @ApiResponse(
            ...
            content = @Content(
                    ...
                    schema = @Schema(implementation = dh.backend.accounts.infrastructure.web.exception.ApiErrorResponse.class),
    ...
    public ResponseEntity<Void> createAccount(@Valid @RequestBody CreateAccountDto accountDto) {
        this.createAccount.execute(AccountFactory.create(accountDto.user()));
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = dh.backend.accounts.infrastructure.web.exception.ApiErrorResponse.class),
                    examples = @ExampleObject(value = ApiErrorResponse.NOT_FOUND)
            )
    )
    @PatchMapping("")
